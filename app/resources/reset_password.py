...
reset_password_namespace = Namespace('reset', description='Namespace untuk reset password')
...
class ForgotPasswordResource(Resource):
	...
	def post(self):
		...
		try:
			...
			return send_email(
				'[Test] Reset password anda',
				sender='eliastheoo2@gmail.com',
	...
	def post(self):
		try:
			...
			return send_email(
				...
				sender='eliastheoo2@gmail.com',
				recipients=[user.email],
				text_body='Reset password berhasil!',
				html_body='<p>Reset password berhasil!</p>'
			)
